 ...
 * @returns {number}
 */
export function get_audio_len() {
    const ret = wasm.get_audio_len();
    return ret >>> 0;
}
 ...
 * @returns {number}
 */
export function get_audio_ptr() {
    const ret = wasm.get_audio_ptr();
    return ret >>> 0;
}
...
export function load_rom(data) {
    ...
    const ret = wasm.load_rom(ptr0, len0);
    return ret;
}
 ...
 * @returns {number}
 */
export function run_frame(c1, c2) {
    const ret = wasm.run_frame(c1, c2);
    return ret >>> 0;
}
